...
boolean P_CheckSight(mobj_t *t1, mobj_t *t2)
{
   ...
   * same subsector? obviously visible. Checked first (ahead of the reject
   * matrix) so melee/close-quarters sight checks skip the numsectors multiply
   * and the reject lookup entirely. We don't care about original-demo sync.
   * (cf. d32xr 77377d2) */
  ...
  pnum = (s1-_g->sectors)*_g->numsectors + (s2-_g->sectors);
