...
#define HU_TITLEX 0
/* Place the automap title immediately above the real PC-FX HUD.  The inherited
 * 160-line formula put it around the middle of the 240-line display. */
#define HU_TITLEY (ST_Y - 1 - SHORT(_g->hu_font[0]->height))
