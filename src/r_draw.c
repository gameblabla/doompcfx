...
void R_SetupViewScaling(void);   /* r_hotpath.c: computes projection tables */
...
void R_InitBuffer()
{
    ...
    // PC-FX: compute the projection tables for the active resolution instead of
    // copying the 120x160 baked consts.
    R_SetupViewScaling();
