...
void R_PrecacheLevel(void);                  // PC-FX: pull level gfx resident (no CD in-game)
void R_SetupFrame (player_t *player);

// Pre-lit flat cache: per-level zone allocation (sized to the map's spare RAM) and
// a per-frame thrash guard. See r_hotpath.c. R_LitFlatLevelInit runs at the end of
// P_SetupLevel; R_LitFlatFrameCheck runs once per rendered frame.
