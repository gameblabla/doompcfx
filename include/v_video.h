...
// PC-FX: draw a patch at native 1:1 full resolution (see v_video.c). x/y are in
// native 256x240 screen space. Used for menu/UI patches and text so small
// graphics stay crisp instead of being downsampled into a garbled mess.
